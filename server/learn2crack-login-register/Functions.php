...
public function registerUser($name, $mobile, $address, $email, $password) {

	$db = $this -> db;

	if (!empty($name) && !empty($mobile) && !empty($address) && !empty($email) && !empty($password)) {
  		...
  		if ($db -> checkUserExist($email)) {
  			...
  			$result = $db -> insertData($name, $mobile, $address, $email, $password);
